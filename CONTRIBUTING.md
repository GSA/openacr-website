...
This document is about how to contribute to the GSA's OpenACR website. This process looks a bit different depending on whether you're a GSA employee or not. Here's what you can find in this doc:
...
OpenACR website is maintained by the General Services Administration (GSA). We encourage contributions consistent with the project's principles:
...
The site is built to WCAG 2.1 AA standards. We are using design patterns from the USWDS where we can that have been extensively tested for accessibility. Feedback around how to improve is always appreciated.
